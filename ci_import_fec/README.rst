...
=================================================================
Importation du Fichier d'Échange Informatisé (FEC) pour la France
=================================================================

Ce module permet d'importer les écritures comptables à partir d'fichier FEC tel que définit par `l'arrêté du 29
...
Pour générer le *FEC*, allez dans le menu *Accounting > Reporting > French Statements > Import FEC* qui va démarrer l'assistant d'import du FEC.
